...
def display_envelope():
    st.markdown(
        ...
        <div style="text-align:center;margin-top:2em;">
            <img src="https://cdn.pixabay.com/photo/2016/04/01/10/09/envelope-1300157_1280.png" width="180" style="border-radius:16px;box-shadow:2px 2px 12px #a80000;">
            <div style="font-size:1.3em; font-family: 'Noto Serif', serif; color:#a80000; margin-top:1em;">
                An invitation is waiting inside!<br>
                <b>Click to open the envelope.</b>
            </div>
        </div>
...
if invite_id:
    ...
    if data:
        ...
        if not st.session_state["envelope_open"]:
            ...
            # Download as image (background only)
            if image_bytes:
    ...
    with st.form("invitation_form"):
        ...
        invitation_message = st.text_area("Invitation Message")
